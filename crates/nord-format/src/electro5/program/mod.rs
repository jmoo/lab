...
impl Schema {
    ...
    ///
    /// The panel list is the one place a field path is spelled by hand; the fields
    /// themselves come from `#[bitpanel]`, so a renamed or added field cannot go stale
    /// here. Adding a *panel* to the schema does need a line in both this and
    /// [`Self::fields`].
