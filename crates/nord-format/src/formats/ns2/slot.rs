...
pub struct Slot {
    ...
    pub extern_on: bool,
    #[bits(154..=156)]
    pub extern_kb_zone: KbZone3,
    #[bits(157..=160)]
    pub extern_octave_shift: OctaveShift,
    #[bits(161..=161)]
    pub extern_pitch_stick: bool,
    #[bits(162..=162)]
    pub extern_sustain_pedal: bool,
    #[bits(174..=175)]
    pub piano_program_output: Selector<2>,
    #[bits(177..=178)]
    pub synth_program_output: Selector<2>,
    #[bits(180..=181)]
    pub organ_program_output: Selector<2>,
    #[bits(182..=182)]
    ...
    #[bits(1119..=1120)]
    pub piano_clavinet_model: Selector<2>,
    #[bits(1121..=1121)]
    ...
    #[bits(1124..=1125)]
    pub piano_dynamics: Selector<2>,
    #[bits(1126..=1127)]
    pub piano_clav_eq_hi: Selector<2>,
    #[bits(1128..=1129)]
    ...
    #[bits(1209..=1212)]
    pub synth_arp_master_clock_divisor: ClockDivision,
    #[bits(1214..=1220)]
    pub synth_arp_rate: Time,
    #[bits(1221..=1222)]
    pub synth_arp_pattern: Selector<2>,
    #[bits(1223..=1224)]
    pub synth_arp_master_range: Selector<2>,
    #[bits(1225..=1225)]
    ...
    #[bits(1291..=1298)]
    pub synth_shape_aftertouch: MorphTarget,
    #[bits(1299..=1306)]
    pub synth_shape_ctrl_pedal: MorphTarget,
    #[bits(1307..=1313)]
    pub synth_shape: Level,
    #[bits(1314..=1320)]
    pub synth_shape_mod: Level,
    #[bits(1321..=1328)]
    pub synth_shape_detune_wheel: MorphTarget,
    #[bits(1329..=1336)]
    pub synth_shape_detune_aftertouch: MorphTarget,
    #[bits(1337..=1344)]
    pub synth_shape_detune_ctrl_pedal: MorphTarget,
    #[bits(1345..=1351)]
    ...
    #[bits(1390..=1396)]
    pub synth_filter_resonance: Level,
    #[bits(1397..=1403)]
    pub synth_filter_mod_2: Bipolar<10>,
    #[bits(1404..=1410)]
    pub synth_filter_mod_1: Bipolar<10>,
    #[bits(1411..=1411)]
    pub synth_filter_kb_track: bool,
    #[bits(1412..=1414)]
    pub synth_filter_type: Selector<3>,
    #[bits(1415..=1421)]
    ...
    #[bits(1485..=1486)]
    pub synth_glide_voice_mode: Selector<2>,
    #[bits(1487..=1489)]
    pub synth_unison: Selector<3>,
    #[bits(1490..=1492)]
    pub synth_vibrato: Selector<3>,
    #[bits(1504..=1505)]
    ...
    #[bits(1569..=1572)]
    pub extern_midi_channel: Selector<4>,
    #[bits(1574..=1574)]
    ...
    #[bits(1756..=1763)]
    pub effect_2_rate_aftertouch: MorphTarget,
    #[bits(1764..=1771)]
    pub effect_2_rate_ctrl_pedal: MorphTarget,
    #[bits(1772..=1778)]
    ...
    #[bits(1825..=1829)]
    pub delay_tempo_master_clock_divisor_ctrl_pedal: MorphOf<5>,
    #[bits(1830..=1833)]
    ...
    #[bits(1901..=1908)]
    pub delay_amount_ctrl_pedal: MorphTarget,
    #[bits(1909..=1915)]
    pub delay_amount: Level,
    #[bits(1916..=1922)]
    ...
    #[bits(1926..=1927)]
    pub amp_type: Selector<2>,
    #[bits(1928..=1934)]
    pub amp_sim_drive: Level,
    #[bits(1935..=1941)]
    pub eq_treble: EqBand,
    #[bits(1942..=1948)]
    pub eq_mid: EqBand,
    #[bits(1949..=1955)]
    pub eq_bass: EqBand,
